...
import com.sammyscl.calendar.adapters.MyMonthPagerAdapter
import com.sammyscl.calendar.extensions.config
import com.sammyscl.calendar.extensions.getMonthCode
...
class MonthFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun updateActionBarTitle() {
        (activity as MainActivityCal).supportActionBar?.title = getString(R.string.app_launcher_name)
    }
